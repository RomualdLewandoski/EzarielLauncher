...
function validateEmail(value) {
    if (value) {
        ...
        lu = false
        showError(loginEmailError, 'Requis')
        loginDisabled(true)
    }
}
...
loginButton.addEventListener('click', () => {
    ...
    AuthManager.addAccount(loginUsername.value, loginPassword.value, launcherConfigs).then((value) => {
        ...
        setOverlayContent('Erreur de connexion', 'Vérifiez vos identifiants', 'Ré-essayer')
        setOverlayHandler(() => {
            formDisabled(false)
            toggleOverlay(false)
        })
